...
import 'package:nomad_toonfilx/widgets/cartoon/screens/episode_widget.dart';
          ...
          child: Column(
            children: [
              ...
              FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    // ListView는 복잡한 구석이 있음. 그래서 Column으로 감싸줌
                    // episode api는 10개 정도 데이터만 리턴하므로 무리 없음! -> length를 몰랐다면 ListView가 나을수도
                    return Column(
                      children: [
